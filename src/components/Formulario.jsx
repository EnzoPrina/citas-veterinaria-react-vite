...
;
  ...
  return (
    <div className="md:w-1/2 lg:w-2/5 mx-5">
        ...
        <p className="text-lg  text-white mt-5 text-center mb-10">
            Añade Pacientes y {''}
        ...
        className="bg-white  shadow-md rounded-xl py-10 px-5 mb-10">
            ...
            <div className="mb-5">
                <label htmlFor="mascota" className="block text-gray-700 uppercase font-bold">Sintomas</label>
                <textarea 
                id="sintomas"
                className="border-2 w-full p-2 mt-2 placeholder-gray-400 rounded-md"
            ...
            <input 
            type="submit"
            className="bg-indigo-600 w-full p-3 text-white uppercase font-bold hover:bg-indigo-700 cursor-pointer transition-all rounded-xl"
